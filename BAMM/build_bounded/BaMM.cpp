...
model_data::model_data(int argc,char * argv[]) : ad_comm(argc,argv)
{
  ...
  altitude.allocate("altitude");
  aspect.allocate("aspect");
  DST_adj.allocate("DST_adj");
  latitude.allocate("latitude");
  longitude.allocate("longitude");
  slope.allocate("slope");
  solar_const.allocate("solar_const");
  GST_adj.allocate("GST_adj");
  transmiss.allocate("transmiss");
  area.allocate("area");
  depth.allocate("depth");
  salinity.allocate("salinity");
  alphaP.allocate("alphaP");
  alphaGk.allocate("alphaGk");
  S_meas_flag.allocate("S_meas_flag");
  Light_sat_flag.allocate("Light_sat_flag");
  est_S_scale.allocate("est_S_scale");
  RK_step_size.allocate("RK_step_size");
  n_irr.allocate("n_irr");
  n_tC.allocate("n_tC");
  n_O2conc.allocate("n_O2conc");
  n_delta_18O_O2.allocate("n_delta_18O_O2");
  irr_data.allocate(1,n_irr,"irr_data");
  irr_day_of_year.allocate(1,n_irr,"irr_day_of_year");
  irr_hour_of_day.allocate(1,n_irr,"irr_hour_of_day");
  irr_time_interval.allocate(1,n_irr,"irr_time_interval");
  tC_data.allocate(1,n_tC,"tC_data");
  tC_day_of_year.allocate(1,n_tC,"tC_day_of_year");
  tC_hour_of_day.allocate(1,n_tC,"tC_hour_of_day");
  tC_time_interval.allocate(1,n_tC,"tC_time_interval");
  O2conc_data.allocate(1,n_O2conc,"O2conc_data");
  O2conc_day_of_year.allocate(1,n_O2conc,"O2conc_day_of_year");
  O2conc_hour_of_day.allocate(1,n_O2conc,"O2conc_hour_of_day");
  O2conc_time_interval.allocate(1,n_O2conc,"O2conc_time_interval");
  delta_18O_O2_data.allocate(1,n_delta_18O_O2,"delta_18O_O2_data");
  delta_18O_O2_day_of_year.allocate(1,n_delta_18O_O2,"delta_18O_O2_day_of_year");
  delta_18O_O2_hour_of_day.allocate(1,n_delta_18O_O2,"delta_18O_O2_hour_of_day");
  delta_18O_O2_time_interval.allocate(1,n_delta_18O_O2,"delta_18O_O2_time_interval");
  end_of_data_value_1.allocate("end_of_data_value_1");
  irr_time_interval_map.allocate(1,n_irr);
  O2conc_time_interval_map.allocate(1,n_O2conc);
  delta_18O_O2_time_interval_map.allocate(1,n_delta_18O_O2);
 ad_comm::change_datafile_name("BaMM.cfg");
  trefC.allocate("trefC");
  base_respir_switch.allocate("base_respir_switch");
  Eb_switch.allocate("Eb_switch");
  Eb_params.allocate(1,4,"Eb_params");
  Ep_switch.allocate("Ep_switch");
  Ep_params.allocate(1,4,"Ep_params");
  beta_prod_switch.allocate("beta_prod_switch");
  beta_prod_params.allocate(1,4,"beta_prod_params");
  N_steps_for_C_pool.allocate("N_steps_for_C_pool");
  isotope_switch.allocate("isotope_switch");
  k20_switch.allocate("k20_switch");
  k20_params.allocate(1,4,"k20_params");
  alphaR_switch.allocate("alphaR_switch");
  alphaR_transform_switch.allocate("alphaR_transform_switch");
  alphaR_params.allocate(1,4,"alphaR_params");
  delta_18O_H2O_switch.allocate("delta_18O_H2O_switch");
  delta_18O_H2O_params.allocate(1,4,"delta_18O_H2O_params");
  init_O2_conc_switch.allocate("init_O2_conc_switch");
  init_O2_conc_params.allocate(1,4,"init_O2_conc_params");
  init_delta_18O_O2_switch.allocate("init_delta_18O_O2_switch");
  init_delta_18O_O2_params.allocate(1,4,"init_delta_18O_O2_params");
  sigma_O2_conc_switch.allocate("sigma_O2_conc_switch");
  sigma_O2_conc_params.allocate(1,4,"sigma_O2_conc_params");
  sigma_delta_18O_O2_switch.allocate("sigma_delta_18O_O2_switch");
  sigma_delta_18O_O2_params.allocate(1,4,"sigma_delta_18O_O2_params");
  delta_18O_O2_scale_factor.allocate("delta_18O_O2_scale_factor");
  end_of_data_value_2.allocate("end_of_data_value_2");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  log_Pmax.allocate(-6.9,11.5,Light_sat_Pmax_phase,"log_Pmax");
  log_I_halfSat.allocate(-6.9,8.517,Light_sat_I_halfSat_phase,"log_I_halfSat");
  log_alpha_P_I.allocate(Light_sat_alpha_P_I_phase,"log_alpha_P_I");
  ...
  log_Rref.allocate(base_respir_phase,"log_Rref");
  log_Eb.allocate(Eb_min,Eb_max,Eb_phase,"log_Eb");
  log_Ep.allocate(Ep_min,Ep_max,Ep_phase,"log_Ep");
  log_beta_prod.allocate(beta_prod_min,beta_prod_max,beta_prod_phase,"log_beta_prod");
  log_k20.allocate(k20_min,k20_max,k20_phase,"log_k20");
 if (alphaR_transform_switch > 0)
 {
  log_alphaR.allocate(alphaR_min,alphaR_max,alphaR_phase,"log_alphaR");
 }
 else
 {
  alphaR.allocate(alphaR_min,alphaR_max,alphaR_phase,"alphaR");
 }
  delta_18O_H2O.allocate(delta_18O_H2O_min,delta_18O_H2O_max,delta_18O_H2O_phase,"delta_18O_H2O");
  log_init_O2_conc.allocate(init_O2_conc_min,init_O2_conc_max,init_O2_conc_phase,"log_init_O2_conc");
  log_init_delta_18O_O2.allocate(init_delta_18O_O2_min,init_delta_18O_O2_max,init_delta_18O_O2_phase,"log_init_delta_18O_O2");
  log_sigma_O2_conc.allocate(sigma_O2_conc_min,sigma_O2_conc_max,sigma_O2_conc_phase,"log_sigma_O2_conc");
  log_sigma_delta_18O_O2.allocate(sigma_delta_18O_O2_min,sigma_delta_18O_O2_max,sigma_delta_18O_O2_phase,"log_sigma_delta_18O_O2");
  est_irr.allocate(1,n_tC,"est_irr");
  #ifndef NO_AD_INITIALIZE
    est_irr.initialize();
  #endif
  est_O2conc.allocate(1,n_tC,"est_O2conc");
  #ifndef NO_AD_INITIALIZE
    est_O2conc.initialize();
  #endif
  est_delta_18O_O2.allocate(1,n_tC,"est_delta_18O_O2");
  #ifndef NO_AD_INITIALIZE
    est_delta_18O_O2.initialize();
  #endif
  O2_Sat.allocate(1,n_tC,"O2_Sat");
  #ifndef NO_AD_INITIALIZE
    O2_Sat.initialize();
  #endif
  Pmax.allocate("Pmax");
  ...
  Pmax.initialize();
  #endif
  I_halfSat.allocate("I_halfSat");
  #ifndef NO_AD_INITIALIZE
  I_halfSat.initialize();
  #endif
  alpha_P_I.allocate("alpha_P_I");
  #ifndef NO_AD_INITIALIZE
  alpha_P_I.initialize();
  #endif
  est_val.allocate(1,2,"est_val");
  Rref.allocate("Rref");
  #ifndef NO_AD_INITIALIZE
  Rref.initialize();
  #endif
  ...
  Ep.initialize();
  #endif
  beta_prod.allocate("beta_prod");
  #ifndef NO_AD_INITIALIZE
  beta_prod.initialize();
  #endif
  k20.allocate("k20");
  #ifndef NO_AD_INITIALIZE
  k20.initialize();
  #endif
  alphaR_real.allocate("alphaR_real");
  #ifndef NO_AD_INITIALIZE
  alphaR_real.initialize();
  #endif
  init_O2_conc.allocate("init_O2_conc");
  #ifndef NO_AD_INITIALIZE
  init_O2_conc.initialize();
  #endif
  init_delta_18O_O2.allocate("init_delta_18O_O2");
  #ifndef NO_AD_INITIALIZE
  init_delta_18O_O2.initialize();
  #endif
  P.allocate(1,n_tC,"P");
  #ifndef NO_AD_INITIALIZE
    P.initialize();
  ...
  R.allocate(1,n_tC,"R");
    ...
    R.initialize();
  #endif
  Rb.allocate(1,n_tC,"Rb");
  #ifndef NO_AD_INITIALIZE
    Rb.initialize();
  #endif
  Rp.allocate(1,n_tC,"Rp");
  #ifndef NO_AD_INITIALIZE
    Rp.initialize();
  #endif
  G.allocate(1,n_tC,"G");
    ...
    G.initialize();
  #endif
  sigma_O2_conc.allocate("sigma_O2_conc");
  #ifndef NO_AD_INITIALIZE
  sigma_O2_conc.initialize();
  #endif
  sigma_delta_18O_O2.allocate("sigma_delta_18O_O2");
  #ifndef NO_AD_INITIALIZE
  sigma_delta_18O_O2.initialize();
  #endif
  Sc20.allocate("Sc20");
  #ifndef NO_AD_INITIALIZE
  Sc20.initialize();
...
void model_parameters::calculate_initial_values(void)
{
...
dvariable model_parameters::Schmidt_number(dvariable tC)
{
    dvariable Sc    = 0.0;
    dvariable m     = 0.0;
...
dvariable model_parameters::k_tC(dvariable tC)
{
    dvariable k = 0.0;
...
dvariable model_parameters::O2_saturation(dvariable tC)
{
...
dvariable model_parameters::delta_to_ratio(dvariable delta_val)
{
...
dvariable model_parameters::ratio_to_delta(dvariable ratio_val)
{
...
dvariable model_parameters::S_at_surface(int day_of_year, dvariable hour_of_day)
{
...
void model_parameters::calculate_estimated_irradiance(void)
{
...
dvariable model_parameters::total_primary_production(dvar_vector local_irr_arr, dvariable local_Pmax, dvariable local_I_halfSat, dvar_vector local_tC_time_interval)
{
    dvariable Pval      = 0.0;
    dvariable p1        = 0.0;
    dvariable p2        = 0.0;
...
dvariable model_parameters::total_respiration(dvar_vector local_tC_data, dvariable local_log_Rref, dvariable local_Eb, dvariable local_Ep, dvariable local_beta_prod, dvar_vector local_tC_time_interval, int respir_type_flag)
{
...
dvariable model_parameters::total_mass_flux(dvar_vector local_tC_data, dvar_vector local_O2_Sat, dvar_vector local_est_O2conc, dvar_vector local_tC_time_interval)
{
    dvariable Gval = 0.0;
    dvariable time_step = 0.0;
    dvariable diel_dur  = 0.0;
...
dvariable model_parameters::calculate_integrated_moving_window_average(dvar_vector data_val, dvar_vector local_tC_time_interval, int istart, int iend, int idx_end_of_first_day)
{
...
void model_parameters::calculate_O2(void)
{
...
dvariable model_parameters::discrete_diffeq(int diffeq_num, dvariable time_step, dvar_vector x, dvariable K_O2, dvariable P_Iso, dvariable a, dvariable B, dvariable c, dvariable D)
{
...
dvar_vector model_parameters::solve_diffeq_RungeKutta(dvariable prev_time, dvariable curr_time, int step_size, dvar_vector x, dvariable K_O2, dvariable P_Iso, dvariable a, dvariable B, dvariable c, dvariable D)
{
    // this function assumes that x is (1,NUM_DIFFEQ)
...
void model_parameters::calculate_objective_function(void)
{
    int i;
    f.initialize();
...
void model_parameters::output_mcmc_parameters(void)
{
...
{
  dvector temp("{1.e-4 1.e-4 1.e-4 1.e-4 1.e-5 1.e-5 1.e-7}");
